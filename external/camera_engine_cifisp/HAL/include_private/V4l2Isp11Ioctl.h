...
class V4l2Isp11Ioctl {
 public:
  ...
  /* dpcc */
  bool getDpccCfg(struct cifisp_dpcc_config& dpccCfg, bool& enable);
  bool setDpccCfg(struct cifisp_dpcc_config& dpccCfg, bool enable);
  /* bls */
  bool getBlsCfg(struct cifisp_bls_config& blsCfg, bool& enable);
  bool setBlsCfg(struct cifisp_bls_config& blsCfg, bool enable);
  /* degamma */
  bool getSdgCfg(struct cifisp_sdg_config& sdgCfg, bool& enable);
  bool setSdgCfg(struct cifisp_sdg_config& sdgCfg, bool enable);
  /* lsc */
  bool getLscCfg(struct cifisp_lsc_config& lscCfg, bool& enable);
  bool setLscCfg(struct cifisp_lsc_config& lscCfg, bool enable);
  /* awb measure */
  bool getAwbMeasCfg(struct cifisp_awb_meas_config& awbCfg, bool& enable);
  bool setAwbMeasCfg(struct cifisp_awb_meas_config& awbCfg, bool enable);
  /* filter */
  bool getFltCfg(struct cifisp_flt_config& fltCfg, bool& enable);
  bool setFltCfg(struct cifisp_flt_config& fltCfg, bool enable);
  /* demosaic */
  bool getBdmCfg(struct cifisp_bdm_config& bdmCfg, bool& enable);
  bool setBdmCfg(struct cifisp_bdm_config& bdmCfg, bool enable);
  /* cross talk */
  bool getCtkCfg(struct cifisp_ctk_config& ctkCfg, bool& enable);
  bool setCtkCfg(struct cifisp_ctk_config& ctkCfg, bool enable);
  /* gamma out */
  bool getGocCfg(struct cifisp_goc_config& gocCfg, bool& enable);
  bool setGocCfg(struct cifisp_goc_config& gocCfg, bool enable);
  /* Histogram Measurement */
  bool getHstCfg(struct cifisp_hst_config& hstCfg, bool& enable);
  bool setHstCfg(struct cifisp_hst_config& hstCfg, bool enable);
  /* Auto Exposure Measurements */
  bool getAecCfg(struct cifisp_aec_config& aecCfg, bool& enable);
  bool setAecCfg(struct cifisp_aec_config& aecCfg, bool enable);
  /* awb gain */
  bool getAwbGainCfg(struct cifisp_awb_gain_config& awbgCfg, bool& enable);
  bool setAwbGainCfg(struct cifisp_awb_gain_config& awbgCfg, bool enable);
  /* color process */
  bool getCprocCfg(struct cifisp_cproc_config& cprocCfg, bool& enable);
  bool setCprocCfg(struct cifisp_cproc_config& cprocCfg, bool enable);
  /* afc */
  bool getAfcCfg(struct cifisp_afc_config& afcCfg, bool& enable);
  bool setAfcCfg(struct cifisp_afc_config& afcCfg, bool enable);
  /* ie */
  bool getIeCfg(struct cifisp_ie_config& ieCfg, bool& enable);
  bool setIeCfg(struct cifisp_ie_config& ieCfg, bool enable);
  /* dpf */
  bool getDpfCfg(struct cifisp_dpf_config& dpfCfg, bool& enable);
  bool setDpfCfg(struct cifisp_dpf_config& dpfCfg, bool enable);

  bool getDpfStrengthCfg(struct cifisp_dpf_strength_config& dpfStrCfg, bool& enable);
  bool setDpfStrengthCfg(struct cifisp_dpf_strength_config& dpfStrCfg, bool enable);

  bool getWdrCfg(struct cifisp_wdr_config& wdrCfg, bool& enable);
 ...
 private:
  ...
  bool getControl(int id, bool& enable);
  int mDevFp;
