...
RKiqAeHandler::AiqAeResult::AiqAeResult()
{
...
void
RKiqAeHandler::AiqAeResult::copy (ia_aiq_ae_results *result)
{
    XCAM_ASSERT (result);
...
RKiqAeHandler::RKiqAeHandler (SmartPtr<RKiqCompositor> &aiq_compositor)
...
bool
RKiqAeHandler::set_description (struct atomisp_sensor_mode_data *sensor_data)
{
...
bool
RKiqAeHandler::ensure_ia_parameters ()
{
    bool ret = true;
...
bool RKiqAeHandler::ensure_ae_mode ()
{
...
bool RKiqAeHandler::ensure_ae_metering_mode ()
{
...
bool RKiqAeHandler::ensure_ae_priority_mode ()
{
    _input.priority_mode = ia_aiq_ae_priority_mode_normal;
    return true;
}

bool RKiqAeHandler::ensure_ae_flicker_mode ()
{
...
bool RKiqAeHandler::ensure_ae_manual ()
{
...
bool RKiqAeHandler::ensure_ae_ev_shift ()
{
...
XCamReturn
RKiqAeHandler::analyze (X3aResultList &output)
{
#if RK_ISP
...
bool
RKiqAeHandler::manual_control_result (
...
void
RKiqAeHandler::adjust_ae_limitation (ia_aiq_exposure_sensor_parameters &cur_res,
                                    ia_aiq_exposure_parameters &cur_aiq_exp)
{
...
XCamFlickerMode
RKiqAeHandler::get_flicker_mode ()
{
    {
        AnalyzerHandler::HandlerLock lock(this);
    }
...
int64_t
RKiqAeHandler::get_current_exposure_time ()
{
    AnalyzerHandler::HandlerLock lock(this);
...
double
RKiqAeHandler::get_current_analog_gain ()
{
    AnalyzerHandler::HandlerLock lock(this);
...
double
RKiqAeHandler::get_max_analog_gain ()
{
    {
        AnalyzerHandler::HandlerLock lock(this);
    }
...
XCamReturn
RKiqAeHandler::set_RGBS_weight_grid (ia_aiq_rgbs_grid **out_rgbs_grid)
{
    AnalyzerHandler::HandlerLock lock(this);
...
XCamReturn
RKiqAeHandler::set_hist_weight_grid (ia_aiq_hist_weight_grid **out_weight_grid)
{
    AnalyzerHandler::HandlerLock lock(this);
...
XCamReturn
RKiqAeHandler::dump_hist_weight_grid (const ia_aiq_hist_weight_grid *weight_grid)
{
...
XCamReturn
RKiqAeHandler::dump_RGBS_grid (const ia_aiq_rgbs_grid *rgbs_grid)
{
...
AiqAwbHandler::AiqAwbHandler (SmartPtr<RKiqCompositor> &aiq_compositor)
    : _aiq_compositor (aiq_compositor)
    , _started (false)
{
...
bool
RKiqCompositor::set_sensor_mode_data (struct atomisp_sensor_mode_data *sensor_mode)
{
...
{
#if RK_ISP
	struct CamIA10_Stats rkisp_stats;

	rkisp_iq_statistics_set(NULL, );
#else
...
XCamReturn
RKiqCompositor::apply_gamma_table (struct atomisp_parameters *isp_param)
{
...
XCamReturn
RKiqCompositor::apply_night_mode (struct atomisp_parameters *isp_param)
{
...
XCamReturn
RKiqCompositor::limit_nr_levels (struct atomisp_parameters *isp_param)
{
...
XCamReturn RKiqCompositor::integrate (X3aResultList &results)
{
    ...
    RKiqAeHandler *aiq_ae = _ae_handler.ptr();
...
SmartPtr<X3aResult>
RKiqCompositor::generate_3a_configs (struct atomisp_parameters *parameters)
{
...
void
RKiqCompositor::set_ae_handler (SmartPtr<RKiqAeHandler> &handler)
{
