...
*/
    ...
    ret = _device->dequeue_buffer (buf);
    ...
    SmartPtr<VideoBuffer> video_buf = new V4l2BufferProxy (buf, _device);
    //RKTODO::get 3a stats from video buffer, and fill into isp_stats
    //isp_stats = video_buf;
