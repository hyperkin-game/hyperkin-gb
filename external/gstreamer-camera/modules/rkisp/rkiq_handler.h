...
public:
    explicit RKiqAeHandler (SmartPtr<RKiqCompositor> &aiq_compositor);
    ~RKiqAeHandler () {}
    ...
    : public AwbHandler
{
    friend class RKiqCompositor;
public:
    explicit AiqAwbHandler (SmartPtr<RKiqCompositor> &aiq_compositor);
    ~AiqAwbHandler () {}
...
public:
    ...
    void set_ae_handler (SmartPtr<RKiqAeHandler> &handler);
...
private:
    ...
    SmartPtr<RKiqAeHandler>     _ae_handler;
